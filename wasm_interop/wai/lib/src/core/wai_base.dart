...
extension type WebAssembly._(JSObject _) {
  ...
  external static JSPromise<WebAssemblyResult> _instantiateStreaming(
      JSPromise wasmStream,
      [JSObject? importObject]);

  @JS('compileStreaming')
  external static JSPromise<WebAssemblyModule> _compileStreaming(
      JSPromise wasmStream);

  @JS('instantiate')
  external static JSPromise<WebAssemblyResult> _instantiateBuffer(
      JSObject wasmBuffer,
      [JSObject? importObject]);

  @JS('instantiate')
  external static JSPromise<WebAssemblyInstance> _instantiateModule(
  ...
  static Future<WebAssemblyResult> instantiateStreaming(JSPromise wasmStream,
      [JSObject? importObject]) {
  ...
  static Future<WebAssemblyResult> instantiateBuffer(JSObject wasmBuffer,
      [JSObject? importObject]) {
    if (importObject == null) {
  ...
  static Future<WebAssemblyInstance> instantiateModule(
      WebAssemblyModule wasmModule,
      [JSObject? importObject]) {
    if (importObject == null) {
  ...
  static Future<JSObject> instantiate(JSObject wasmObj,
      [JSObject? importObject]) {
  ...
  static Future<WebAssemblyModule> compileStreaming(JSPromise wasmStream) =>
      _compileStreaming(wasmStream).toDart;
  ...
  static Future<WebAssemblyModule> compile(JSObject wasmBuffer) =>
      _compile(wasmBuffer).toDart;
  ...
  static WebAssemblyMemory Memory(
          {required int initial, int? maximum, bool? shared}) =>
      WebAssemblyMemory.instantiate(
          initial: initial, maximum: maximum, shared: shared);

  /// Instantiates a new `WebAssembly.Table` Object
  ///
  ///
  static WebAssemblyTable Table(
          {required String element,
          required int initial,
          int? maximum,
          JSObject? value}) =>
      WebAssemblyTable.instantiate(
          element: element, initial: initial, maximum: maximum, value: value);
  ...
  static JSObject Global(JSAny value,
          {required String descValue, required bool mutable}) =>
      WebAssemblyGlobal.instantiate(
          descValue: descValue, mutable: mutable, value);
}
